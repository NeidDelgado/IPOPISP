...
<div class="container"> <br><br><br><br><br><br><br><br>
    ...
    <div class="row section_featured_texts section_featured_texts_no_m">
        <div class="nine columns">
           <h2>&nbsp;&nbsp; &nbsp; &nbsp; &nbsp;<?php echo __('Investor'); ?> </h2>
           <?php echo $this->Html->link($this->Html->image('investidor.png'), '/screenshots_investor', array('escape' => false)); ?>
        </div>
        <div class="destaq">
                ...
                <td valign="top"> <table width="100%" border="0" cellpadding="0" cellspacing="0">
                    <tr> 
                      <td width="45%"><strong>SCREENSHOTS<br>
                        <font color="#003399" size="3" face="Verdana, Arial, Helvetica, sans-serif"><strong>&quot;Investor&quot;</strong></font></strong></td>
                      <td width="55%" valign="top"><div align="right"></div></td>
                    </tr>
                  </table>
                  <p><img src="images/investidor.gif" width="522" height="372"></p>
                  <p align="justify"><br>
                  </p>
                  </td>
                <td>&nbsp;</td>
