    ...
    <div class="row section_featured_texts section_featured_texts_no_m">
        <div class="nine columns">
            <div class="one-thirdd column">
                ...
                <strong><h6><?php echo $this->Html->image('setinha.png'); ?><?php echo $this->Html->link(__('WIKIPEDIA CRAY'),'/marksofesteem00', array('escape' => false)); ?></h6></strong>
                <p><?php echo $this->Html->image('setinha.png'); ?><?php echo $this->Html->link(__('The Historic Background.'),'/marksofesteem01', array('escape' => false)); ?><br>
                    ...
                    <?php echo $this->Html->image('setinha.png'); ?><?php echo $this->Html->link(__('CommunicationHigh School Kid&CloseCurlyQuote;s Computer Company.'),'/marksofesteem04', array('escape' => false)); ?><br>
            ...
            <div class="one-thirdd column ">
                <strong><h6><?php echo $this->Html->image('setinha.png'); ?><?php echo $this->Html->link(__('INVENTIONS THAT MODIFIED OUR LIFE'),'/marksofesteem19', array('escape' => false)); ?></h6></strong>
                <p><?php echo $this->Html->image('setinha.png'); ?><?php echo $this->Html->link(__('Calculating Machines and Computing.'),'/marksofesteem20', array('escape' => false)); ?><br>
                <?php echo $this->Html->image('setinha.png'); ?><?php echo $this->Html->link(__('Cloth and Clothing.'),'/marksofesteem21', array('escape' => false)); ?><br>
                <?php echo $this->Html->image('setinha.png'); ?><?php echo $this->Html->link(__('Communication.'),'/marksofesteem22', array('escape' => false)); ?><br>
                <?php echo $this->Html->image('setinha.png'); ?><?php echo $this->Html->link(__('Construction.'),'/marksofesteem23', array('escape' => false)); ?><br>
                <?php echo $this->Html->image('setinha.png'); ?><?php echo $this->Html->link(__('Electricity and Electronics.'),'/marksofesteem24', array('escape' => false)); ?><br>
                <?php echo $this->Html->image('setinha.png'); ?><?php echo $this->Html->link(__('Food and Agriculture.'),'/marksofesteem25', array('escape' => false)); ?><br>
                <?php echo $this->Html->image('setinha.png'); ?><?php echo $this->Html->link(__('Medicine and Biotechnology.'),'/marksofesteem26', array('escape' => false)); ?><br>
                <?php echo $this->Html->image('setinha.png'); ?><?php echo $this->Html->link(__('Industrial Materials.'),'/marksofesteem27', array('escape' => false)); ?><br>
                <?php echo $this->Html->image('setinha.png'); ?><?php echo $this->Html->link(__('Scientific Instrument and Devices.'),'/marksofesteem28', array('escape' => false)); ?><br>
                <?php echo $this->Html->image('setinha.png'); ?><?php echo $this->Html->link(__('Transportation and Energy.'),'/marksofesteem29', array('escape' => false)); ?><br>
